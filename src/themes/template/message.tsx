    ...
    return (
        ...
        >
            <motion.div
                ...
                className='template__message__inner'
                style={{
                    alignItems:
            ...
            >
                <div className='template__message__username'>
                    <div className='template__message__username--badges'>
                ...
                <div
                    className='template__message__content'
